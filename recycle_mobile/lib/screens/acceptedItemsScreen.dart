...
class AcceptedItemsScreen extends StatefulWidget {
  const AcceptedItemsScreen({super.key});
  ...
  final List<Map<String, dynamic>> items = [
    {
      ...
      "price": "Rp50/Botol",
      "image": "assets/images/botolBening.png",
      "category": "bening",
      "quantity": 0,
    },
    {
    ...
    },
    {
      ...
      "price": "Rp24/Botol",
      "image": "assets/images/botolWarna.png",
      "category": "warna",
      "quantity": 0,
    },
    {
      ...
      backgroundColor: AppColors.lightPrimaryColor,
        appBar: AppBar(
          ...
          leading: IconButton(
            ...
            icon: Icon(Icons.arrow_back, color: Colors.black), // Left arrow icon
          ),
            ...
            SizedBox(
              ...
              child: ListView(
                ...
                children: [
                  ...
                  _categoryButtonWithImage("bening", "assets/images/botolBening.png",
                      "Bening", categoryButtonSize, imageSize),
                  _categoryButtonWithImage("warna", "assets/images/botolWarna.png",
